...
- [Intro to data visualization with d3 v4](https://frontendmasters.com/courses/d3-v4/introduction/)
- [Data Visualization for React Developers](https://frontendmasters.com/courses/d3-js-react/)
- [Building Custom Data Visualizations](https://frontendmasters.com/workshops/building-dataviz/)

## Recommendations
- [Data sketches](http://www.datasketch.es/)
- [Blocks builder](https://blockbuilder.org/)
